...
describe("intent-first UI contract", () => {
  ...
  it("uses PNG as the primary export and keeps alternate formats", () => {
    ...
    expect(mainSource).toContain('id="downloadSelectedButton"');
    expect(mainSource.indexOf('id="copyImage"')).toBeLessThan(mainSource.indexOf('id="shareImage"'));
    expect(mainSource.indexOf('id="shareImage"')).toBeLessThan(mainSource.indexOf('id="downloadSelectedButton"'));
  ...
  it("preserves custom color, logo, and offline controls", () => {
    ...
    expect(mainSource).toContain('id="model3dReliefMode"');
    ...
    expect(mainSource).toContain('id="model3dResetView"');
    expect(mainSource).toContain("wire3dPreviewControls();");
